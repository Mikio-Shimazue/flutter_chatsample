...
class ChatCustomBottomWidget extends StatefulWidget {
  /// Creates [ChatCustomBottomWidget] widget
  const ChatCustomBottomWidget({
    Key? key,
  ...
  /// [TextField] state inside the [ChatCustomBottomWidget] widget.
  ...
  @override
  _ChatCustomBottomWidgetState createState() => _ChatCustomBottomWidgetState();
}

/// [ChatCustomBottomWidget] widget state
class _ChatCustomBottomWidgetState extends State<ChatCustomBottomWidget> {
  ...
  void initState() {
    ...
    _inputFocusNode = widget.chatInputFocusNode ?? FocusNode();
    _textController = widget.chatTextController ?? TextEditingController();
...
//    _textController = TextEditingController();
  ...
  @override
  void didUpdateWidget(covariant ChatCustomBottomWidget oldWidget) {
